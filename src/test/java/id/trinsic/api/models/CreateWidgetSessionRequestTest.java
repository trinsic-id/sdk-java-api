...
/**
 * Model tests for CreateWidgetSessionRequest
 */
class CreateWidgetSessionRequestTest {
    private final CreateWidgetSessionRequest model = new CreateWidgetSessionRequest();
