 ...
 */
@JsonPropertyOrder({
  ZimbabweNidLookup2Input.JSON_PROPERTY_ID_NUMBER
})
...
public class ZimbabweNidLookup2Input {
  ...
  public ZimbabweNidLookup2Input() { 
  }

  public ZimbabweNidLookup2Input idNumber(@javax.annotation.Nullable String idNumber) {
  ...
  /**
   * Return true if this ZimbabweNidLookup2Input object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ZimbabweNidLookup2Input zimbabweNidLookup2Input = (ZimbabweNidLookup2Input) o;
    return equalsNullable(this.idNumber, zimbabweNidLookup2Input.idNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class ZimbabweNidLookup2Input {\n");
