...
public class SmartIdInput {
  ...
  @JsonProperty(value = JSON_PROPERTY_SMART_ID_NUMBER, required = false)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSmartIdNumber() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%ssmartIdNumber%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSmartIdNumber()))));
    }
