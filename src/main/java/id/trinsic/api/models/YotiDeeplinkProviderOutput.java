 ...
 */
@JsonPropertyOrder({
  YotiDeeplinkProviderOutput.JSON_PROPERTY_REMEMBER_ME_ID,
  YotiDeeplinkProviderOutput.JSON_PROPERTY_EMAIL,
  YotiDeeplinkProviderOutput.JSON_PROPERTY_GIVEN_NAME,
  YotiDeeplinkProviderOutput.JSON_PROPERTY_FAMILY_NAME,
  YotiDeeplinkProviderOutput.JSON_PROPERTY_FULL_NAME,
  YotiDeeplinkProviderOutput.JSON_PROPERTY_DATE_OF_BIRTH,
  YotiDeeplinkProviderOutput.JSON_PROPERTY_GENDER,
  YotiDeeplinkProviderOutput.JSON_PROPERTY_NATIONALITY,
  YotiDeeplinkProviderOutput.JSON_PROPERTY_MOBILE_NUMBER,
  YotiDeeplinkProviderOutput.JSON_PROPERTY_STRUCTURED_POSTAL_ADDRESS,
...
public class YotiDeeplinkProviderOutput {
  ...
  public YotiDeeplinkProviderOutput() { 
  }

  public YotiDeeplinkProviderOutput rememberMeId(@javax.annotation.Nullable UUID rememberMeId) {
  ...
  public YotiDeeplinkProviderOutput email(@javax.annotation.Nullable String email) {
  ...
  public YotiDeeplinkProviderOutput givenName(@javax.annotation.Nullable String givenName) {
  ...
  public YotiDeeplinkProviderOutput familyName(@javax.annotation.Nullable String familyName) {
  ...
  public YotiDeeplinkProviderOutput fullName(@javax.annotation.Nullable String fullName) {
  ...
  public YotiDeeplinkProviderOutput dateOfBirth(@javax.annotation.Nullable LocalDate dateOfBirth) {
  ...
  public YotiDeeplinkProviderOutput gender(@javax.annotation.Nullable String gender) {
  ...
  public YotiDeeplinkProviderOutput nationality(@javax.annotation.Nullable String nationality) {
  ...
  public YotiDeeplinkProviderOutput mobileNumber(@javax.annotation.Nullable String mobileNumber) {
  ...
  public YotiDeeplinkProviderOutput structuredPostalAddress(@javax.annotation.Nullable YotiStructuredPostalAddress structuredPostalAddress) {
  ...
  public YotiDeeplinkProviderOutput postalAddress(@javax.annotation.Nullable String postalAddress) {
  ...
  public YotiDeeplinkProviderOutput documentDetails(@javax.annotation.Nullable YotiDocumentDetails documentDetails) {
  ...
  /**
   * Return true if this YotiDeeplinkProviderOutput object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    YotiDeeplinkProviderOutput yotiDeeplinkProviderOutput = (YotiDeeplinkProviderOutput) o;
    return equalsNullable(this.rememberMeId, yotiDeeplinkProviderOutput.rememberMeId) &&
        equalsNullable(this.email, yotiDeeplinkProviderOutput.email) &&
        equalsNullable(this.givenName, yotiDeeplinkProviderOutput.givenName) &&
        equalsNullable(this.familyName, yotiDeeplinkProviderOutput.familyName) &&
        equalsNullable(this.fullName, yotiDeeplinkProviderOutput.fullName) &&
        equalsNullable(this.dateOfBirth, yotiDeeplinkProviderOutput.dateOfBirth) &&
        equalsNullable(this.gender, yotiDeeplinkProviderOutput.gender) &&
        equalsNullable(this.nationality, yotiDeeplinkProviderOutput.nationality) &&
        equalsNullable(this.mobileNumber, yotiDeeplinkProviderOutput.mobileNumber) &&
        equalsNullable(this.structuredPostalAddress, yotiDeeplinkProviderOutput.structuredPostalAddress) &&
        equalsNullable(this.postalAddress, yotiDeeplinkProviderOutput.postalAddress) &&
        equalsNullable(this.documentDetails, yotiDeeplinkProviderOutput.documentDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class YotiDeeplinkProviderOutput {\n");
