 ...
 */
@JsonPropertyOrder({
  KenyaNidBiometric2Input.JSON_PROPERTY_ID_NUMBER,
...
public class KenyaNidBiometric2Input {
  ...
  public KenyaNidBiometric2Input() { 
  }

  public KenyaNidBiometric2Input idNumber(@javax.annotation.Nullable String idNumber) {
  ...
  public KenyaNidBiometric2Input livenessImages(@javax.annotation.Nullable List<byte[]> livenessImages) {
    this.livenessImages = JsonNullable.<List<byte[]>>of(livenessImages);
    return this;
  }

  public KenyaNidBiometric2Input addLivenessImagesItem(byte[] livenessImagesItem) {
  ...
  public KenyaNidBiometric2Input testSelfie(@javax.annotation.Nullable byte[] testSelfie) {
  ...
  /**
   * Return true if this KenyaNidBiometric2Input object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    KenyaNidBiometric2Input kenyaNidBiometric2Input = (KenyaNidBiometric2Input) o;
    return equalsNullable(this.idNumber, kenyaNidBiometric2Input.idNumber) &&
        equalsNullable(this.livenessImages, kenyaNidBiometric2Input.livenessImages) &&
        equalsNullable(this.testSelfie, kenyaNidBiometric2Input.testSelfie);
  }
  ...
  public String toString() {
    ...
    sb.append("class KenyaNidBiometric2Input {\n");
