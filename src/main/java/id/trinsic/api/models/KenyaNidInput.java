 ...
 */
@JsonPropertyOrder({
  KenyaNidInput.JSON_PROPERTY_FIRST_NAME,
  KenyaNidInput.JSON_PROPERTY_MIDDLE_NAME,
  KenyaNidInput.JSON_PROPERTY_LAST_NAME,
  KenyaNidInput.JSON_PROPERTY_DATE_OF_BIRTH,
...
public class KenyaNidInput {
  ...
  public KenyaNidInput() { 
  }

  public KenyaNidInput firstName(@javax.annotation.Nonnull String firstName) {
  ...
  public KenyaNidInput middleName(@javax.annotation.Nullable String middleName) {
  ...
  public KenyaNidInput lastName(@javax.annotation.Nonnull String lastName) {
  ...
  public KenyaNidInput dateOfBirth(@javax.annotation.Nonnull LocalDate dateOfBirth) {
  ...
  public KenyaNidInput gender(@javax.annotation.Nonnull String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public KenyaNidInput nationalIdNumber(@javax.annotation.Nonnull String nationalIdNumber) {
  ...
  /**
   * Return true if this KenyaNidInput object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    KenyaNidInput kenyaNidInput = (KenyaNidInput) o;
    return Objects.equals(this.firstName, kenyaNidInput.firstName) &&
        equalsNullable(this.middleName, kenyaNidInput.middleName) &&
        Objects.equals(this.lastName, kenyaNidInput.lastName) &&
        Objects.equals(this.dateOfBirth, kenyaNidInput.dateOfBirth) &&
        Objects.equals(this.gender, kenyaNidInput.gender) &&
        Objects.equals(this.nationalIdNumber, kenyaNidInput.nationalIdNumber);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(firstName, hashCodeNullable(middleName), lastName, dateOfBirth, gender, nationalIdNumber);
  }
