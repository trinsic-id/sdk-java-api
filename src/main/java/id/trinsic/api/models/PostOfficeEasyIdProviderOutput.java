 ...
 */
@JsonPropertyOrder({
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_REMEMBER_ME_ID,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_EMAIL,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_GIVEN_NAME,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_FAMILY_NAME,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_FULL_NAME,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_DATE_OF_BIRTH,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_GENDER,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_NATIONALITY,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_MOBILE_NUMBER,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_STRUCTURED_POSTAL_ADDRESS,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_POSTAL_ADDRESS,
  PostOfficeEasyIdProviderOutput.JSON_PROPERTY_DOCUMENT_DETAILS
})
...
public class PostOfficeEasyIdProviderOutput {
  ...
  public PostOfficeEasyIdProviderOutput() { 
  }

  public PostOfficeEasyIdProviderOutput rememberMeId(@javax.annotation.Nullable UUID rememberMeId) {
  ...
  public PostOfficeEasyIdProviderOutput email(@javax.annotation.Nullable String email) {
  ...
  public PostOfficeEasyIdProviderOutput givenName(@javax.annotation.Nullable String givenName) {
  ...
  public PostOfficeEasyIdProviderOutput familyName(@javax.annotation.Nullable String familyName) {
  ...
  public PostOfficeEasyIdProviderOutput fullName(@javax.annotation.Nullable String fullName) {
  ...
  public PostOfficeEasyIdProviderOutput dateOfBirth(@javax.annotation.Nullable LocalDate dateOfBirth) {
  ...
  public PostOfficeEasyIdProviderOutput gender(@javax.annotation.Nullable String gender) {
  ...
  public PostOfficeEasyIdProviderOutput nationality(@javax.annotation.Nullable String nationality) {
  ...
  public PostOfficeEasyIdProviderOutput mobileNumber(@javax.annotation.Nullable String mobileNumber) {
  ...
  public PostOfficeEasyIdProviderOutput structuredPostalAddress(@javax.annotation.Nullable YotiStructuredPostalAddress structuredPostalAddress) {
  ...
  public PostOfficeEasyIdProviderOutput postalAddress(@javax.annotation.Nullable String postalAddress) {
  ...
  public PostOfficeEasyIdProviderOutput documentDetails(@javax.annotation.Nullable YotiDocumentDetails documentDetails) {
  ...
  /**
   * Return true if this PostOfficeEasyIdProviderOutput object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PostOfficeEasyIdProviderOutput postOfficeEasyIdProviderOutput = (PostOfficeEasyIdProviderOutput) o;
    return equalsNullable(this.rememberMeId, postOfficeEasyIdProviderOutput.rememberMeId) &&
        equalsNullable(this.email, postOfficeEasyIdProviderOutput.email) &&
        equalsNullable(this.givenName, postOfficeEasyIdProviderOutput.givenName) &&
        equalsNullable(this.familyName, postOfficeEasyIdProviderOutput.familyName) &&
        equalsNullable(this.fullName, postOfficeEasyIdProviderOutput.fullName) &&
        equalsNullable(this.dateOfBirth, postOfficeEasyIdProviderOutput.dateOfBirth) &&
        equalsNullable(this.gender, postOfficeEasyIdProviderOutput.gender) &&
        equalsNullable(this.nationality, postOfficeEasyIdProviderOutput.nationality) &&
        equalsNullable(this.mobileNumber, postOfficeEasyIdProviderOutput.mobileNumber) &&
        equalsNullable(this.structuredPostalAddress, postOfficeEasyIdProviderOutput.structuredPostalAddress) &&
        equalsNullable(this.postalAddress, postOfficeEasyIdProviderOutput.postalAddress) &&
        equalsNullable(this.documentDetails, postOfficeEasyIdProviderOutput.documentDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostOfficeEasyIdProviderOutput {\n");
