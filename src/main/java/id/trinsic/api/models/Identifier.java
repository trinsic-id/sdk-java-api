 ...
 */
@JsonPropertyOrder({
  Identifier.JSON_PROPERTY_IDENTIFIER,
  Identifier.JSON_PROPERTY_SCOPE,
  Identifier.JSON_PROPERTY_DESCRIPTION
})
...
public class Identifier {
  ...
  public Identifier identifier(@javax.annotation.Nonnull String identifier) {
  ...
  public Identifier scope(@javax.annotation.Nonnull String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public Identifier description(@javax.annotation.Nonnull String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, identifier.identifier) &&
        Objects.equals(this.scope, identifier.scope) &&
        Objects.equals(this.description, identifier.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifier, scope, description);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIdentifier() != null) {
      joiner.add(String.format("%sidentifier%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIdentifier()))));
    }
