 ...
 */
@JsonPropertyOrder({
  YotiProviderOutput.JSON_PROPERTY_REMEMBER_ME_ID,
  YotiProviderOutput.JSON_PROPERTY_EMAIL,
  YotiProviderOutput.JSON_PROPERTY_GIVEN_NAME,
  YotiProviderOutput.JSON_PROPERTY_FAMILY_NAME,
  YotiProviderOutput.JSON_PROPERTY_FULL_NAME,
  YotiProviderOutput.JSON_PROPERTY_DATE_OF_BIRTH,
  YotiProviderOutput.JSON_PROPERTY_GENDER,
  YotiProviderOutput.JSON_PROPERTY_NATIONALITY,
  YotiProviderOutput.JSON_PROPERTY_MOBILE_NUMBER,
  YotiProviderOutput.JSON_PROPERTY_STRUCTURED_POSTAL_ADDRESS,
  YotiProviderOutput.JSON_PROPERTY_POSTAL_ADDRESS,
  YotiProviderOutput.JSON_PROPERTY_DOCUMENT_DETAILS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-03-12T16:16:44.206360395Z[Etc/UTC]", comments = "Generator version: 7.13.0")
public class YotiProviderOutput {
  ...
  public YotiProviderOutput() { 
  }

  public YotiProviderOutput rememberMeId(@javax.annotation.Nullable UUID rememberMeId) {
  ...
  public YotiProviderOutput email(@javax.annotation.Nullable String email) {
  ...
  public YotiProviderOutput givenName(@javax.annotation.Nullable String givenName) {
  ...
  public YotiProviderOutput familyName(@javax.annotation.Nullable String familyName) {
  ...
  public YotiProviderOutput fullName(@javax.annotation.Nullable String fullName) {
  ...
  public YotiProviderOutput dateOfBirth(@javax.annotation.Nullable LocalDate dateOfBirth) {
  ...
  public YotiProviderOutput gender(@javax.annotation.Nullable String gender) {
  ...
  public YotiProviderOutput nationality(@javax.annotation.Nullable String nationality) {
  ...
  public YotiProviderOutput mobileNumber(@javax.annotation.Nullable String mobileNumber) {
  ...
  public YotiProviderOutput structuredPostalAddress(@javax.annotation.Nullable YotiStructuredPostalAddress structuredPostalAddress) {
  ...
  public YotiProviderOutput postalAddress(@javax.annotation.Nullable String postalAddress) {
  ...
  public YotiProviderOutput documentDetails(@javax.annotation.Nullable YotiDocumentDetails documentDetails) {
  ...
  /**
   * Return true if this YotiProviderOutput object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    YotiProviderOutput yotiProviderOutput = (YotiProviderOutput) o;
    return equalsNullable(this.rememberMeId, yotiProviderOutput.rememberMeId) &&
        equalsNullable(this.email, yotiProviderOutput.email) &&
        equalsNullable(this.givenName, yotiProviderOutput.givenName) &&
        equalsNullable(this.familyName, yotiProviderOutput.familyName) &&
        equalsNullable(this.fullName, yotiProviderOutput.fullName) &&
        equalsNullable(this.dateOfBirth, yotiProviderOutput.dateOfBirth) &&
        equalsNullable(this.gender, yotiProviderOutput.gender) &&
        equalsNullable(this.nationality, yotiProviderOutput.nationality) &&
        equalsNullable(this.mobileNumber, yotiProviderOutput.mobileNumber) &&
        equalsNullable(this.structuredPostalAddress, yotiProviderOutput.structuredPostalAddress) &&
        equalsNullable(this.postalAddress, yotiProviderOutput.postalAddress) &&
        equalsNullable(this.documentDetails, yotiProviderOutput.documentDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class YotiProviderOutput {\n");
