 ...
 */
@JsonPropertyOrder({
  NigeriaNinLookup2Input.JSON_PROPERTY_ID_NUMBER
})
...
public class NigeriaNinLookup2Input {
  ...
  public NigeriaNinLookup2Input() { 
  }

  public NigeriaNinLookup2Input idNumber(@javax.annotation.Nullable String idNumber) {
  ...
  /**
   * Return true if this NigeriaNinLookup2Input object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NigeriaNinLookup2Input nigeriaNinLookup2Input = (NigeriaNinLookup2Input) o;
    return equalsNullable(this.idNumber, nigeriaNinLookup2Input.idNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class NigeriaNinLookup2Input {\n");
