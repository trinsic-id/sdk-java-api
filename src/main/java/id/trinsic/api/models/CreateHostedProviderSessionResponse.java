...
public class CreateHostedProviderSessionResponse {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_LAUNCH_URL, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLaunchUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%slaunchUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLaunchUrl()))));
    }
