...
|**personalIdentifier** | **String** | The personal identifier for Norwegian BankID.              This uniquely identifies the individual in the Norwegian BankID system and is considered a stable identifier to use. |  [optional] |
